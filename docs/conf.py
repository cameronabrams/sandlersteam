...
html_theme_options = {
    ...
    "footer_icons": [
        {
            "name": "GitHub",
            "url": "https://github.com/cameronabrams/sandlersteam",
            "html": """
    ...
    # ===== Source Links =====
    "source_repository": "https://github.com/cameronabrams/sandlersteam",
    "source_branch": "main",
...
latex_documents = [
    (master_doc, 'sandlersteam.tex', 'sandlersteam Documentation',
     author, 'manual'),
]
